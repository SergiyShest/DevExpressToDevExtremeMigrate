...
namespace UI.Areas.Workflow.Controllers{
    [Area("Workflow")]
    public class ProcessController : GenericJournalController<vAnswer2>
    {
        public ProcessController(IHttpContextAccessor httpContextAccessor) : base(httpContextAccessor) { }
