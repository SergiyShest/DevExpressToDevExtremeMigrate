...
describe('Тест журнала PatientJournal', () => {
  it('проверка фильра на наличие записей', () => {
      cy.visit('https://localhost:7210/Common/PatientJournal')
    //cy.contains('H1', 'Patient journal')
    cy.get('#d1From').type('2020-12-20').blur();
    cy.get('#d1To').type('2023-12-31').blur();
